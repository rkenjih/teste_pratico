...
[assembly: WebActivatorEx.PostApplicationStartMethod( typeof(EISOL_TestePraticoWebForms.App_Start.UnityWebFormsStart), "PostStart" )]
namespace EISOL_TestePraticoWebForms.App_Start
{
	/// <summary>
	...
	internal static class UnityWebFormsStart
	{
		...
		private static void RegisterDependencies( IUnityContainer container )
		{
            ...
            container.AddNewExtension<DAODependencyInjectionModule>();
            container.AddNewExtension<BLLDependencyInjectionModule>();
        }
    }
}