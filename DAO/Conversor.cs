...
namespace DAO
{
    public static class Conversor
    {
        ...
        public static T ConverterParaObjeto<T>(DataTable dataTable)
        {
        ...
        /// <author>FRR201502121447</author>
        public static List<T> ConverterParaLista<T>(DataTable dataTable)
        {
        ...
        public static Dictionary<Key, Value> ConverterParaDicionario<Key, Value>(this DataTable dataTable, Func<DataRow, Key> chave, Func<DataRow, Value> valor)
        {
        ...
        /// <author>FRR201511131110</author>
        public static List<DataRow> ConverterParaListaGenerica(DataTable dataTable)
        {
        ...
        /// <author>FRR201502121447</author>
        private static T CarregarItem<T>(DataRow dataRow)
        {
