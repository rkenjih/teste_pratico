...
namespace BLL
{
    public class PESSOAS
    {
        ...
        public DAO.PESSOAS Adicionar(DAO.PESSOAS entidade)
        {
            ...
            new DAO.ConexaoBD().Executar("DBAODB.DML_TESTE_DEV_PESSOAS.INS_TESTE_DEV_PESSOAS", CommandType.StoredProcedure, "out_COD_PESSOA", parametros);
        ...
        public void Editar(DAO.PESSOAS entidade)
        {
            ...
            parametros[6] = new Oracle.ManagedDataAccess.Client.OracleParameter("in_SEXO", entidade.SEXO);
            parametros[7] = new Oracle.ManagedDataAccess.Client.OracleParameter("in_DATA_NASCIMENTO", entidade.DATA_NASCIMENTO);
            new DAO.ConexaoBD().ExecutarSemRetorno("DBAODB.DML_TESTE_DEV_PESSOAS.UPD_TESTE_DEV_PESSOAS", CommandType.StoredProcedure, parametros);
        }
        ...
        public void Excluir(decimal id)
        {
            ...
            new DAO.ConexaoBD().ExecutarSemRetorno("DBAODB.DML_TESTE_DEV_PESSOAS.DEL_TESTE_DEV_PESSOAS", CommandType.StoredProcedure, parametros);
        }
