...
namespace BLL
{
    public class PESSOAS
    {
        ...
        public DAO.PESSOAS Carregar(decimal id)
        {
            ...
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("COD_PESSOA", id);
        ...
        public DAO.PESSOAS Adicionar(DAO.PESSOAS entidade)
        {
            ...
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("out_COD_PESSOA", -1);
            parametros[1] = new Oracle.DataAccess.Client.OracleParameter("in_NOME", entidade.NOME);
            parametros[2] = new Oracle.DataAccess.Client.OracleParameter("in_CPF", entidade.CPF);
            parametros[3] = new Oracle.DataAccess.Client.OracleParameter("in_RG", entidade.RG);
            parametros[4] = new Oracle.DataAccess.Client.OracleParameter("in_TELEFONE", entidade.TELEFONE);
            parametros[5] = new Oracle.DataAccess.Client.OracleParameter("in_EMAIL", entidade.EMAIL);
            parametros[6] = new Oracle.DataAccess.Client.OracleParameter("in_SEXO", entidade.SEXO);
            parametros[7] = new Oracle.DataAccess.Client.OracleParameter("in_DATA_NASCIMENTO", entidade.DATA_NASCIMENTO);
        ...
        {
            var parametros = new System.Data.Common.DbParameter[8];
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("in_COD_PESSOA", entidade.COD_PESSOA);
            parametros[1] = new Oracle.DataAccess.Client.OracleParameter("in_NOME", entidade.NOME);
            parametros[2] = new Oracle.DataAccess.Client.OracleParameter("in_CPF", entidade.CPF);
            parametros[3] = new Oracle.DataAccess.Client.OracleParameter("in_RG", entidade.RG);
            parametros[4] = new Oracle.DataAccess.Client.OracleParameter("in_TELEFONE", entidade.TELEFONE);
        ...
        {
            var parametros = new System.Data.Common.DbParameter[1];
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("in_COD_PESSOA", id);
