...
namespace BLL
{
    public class UF
    {
        ...
        private const string SELECT = @"
            SELECT COD_UF, NOME FROM TESTE.TB_TESTE_UF
        ";
        ...
        public DAO.UF Carregar(decimal id)
        {
            ...
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("COD_UF", id);
        ...
        public DAO.UF Adicionar(DAO.UF entidade)
        {
            ...
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("out_COD_UF", -1);
            parametros[1] = new Oracle.DataAccess.Client.OracleParameter("in_NOME", entidade.NOME);
            parametros[0].Direction = ParameterDirection.Output;
            new DAO.ConexaoBD().Executar("TESTE.DML_TB_TESTE_UF.INS_TB_TESTE_UF", CommandType.StoredProcedure, "out_COD_UF", parametros);
        ...
        {
            var parametros = new System.Data.Common.DbParameter[2];
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("in_COD_UF", entidade.COD_UF);
            parametros[1] = new Oracle.DataAccess.Client.OracleParameter("in_NOME", entidade.NOME);
            new DAO.ConexaoBD().ExecutarSemRetorno("TESTE.DML_TB_TESTE_UF.UPD_TB_TESTE_UF", CommandType.StoredProcedure, parametros);
        }
        ...
        {
            var parametros = new System.Data.Common.DbParameter[1];
            parametros[0] = new Oracle.DataAccess.Client.OracleParameter("in_COD_UF", id);
            new DAO.ConexaoBD().ExecutarSemRetorno("TESTE.DML_TB_TESTE_UF.DEL_TB_TESTE_UF", CommandType.StoredProcedure, parametros);
        }
